              ...
              {isConnected ? (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-2 rounded-xl bg-bg-tertiary border border-border-subtle hover:border-accent-gold/30 transition-all"
                  >
                    {isPremium && (
                    ...
                    <span className="font-mono text-sm text-text-primary">{formattedWallet}</span>
                  ...
                  {/* User Dropdown */}
                  {showUserMenu && (
                    <div className="absolute right-0 top-full mt-2 w-48 rounded-xl bg-bg-card border border-border-subtle shadow-xl overflow-hidden">
                      {isAdmin && (
                        <Link
                          href="/admin"
                          onClick={() => setShowUserMenu(false)}
                          className="flex items-center gap-2 px-4 py-3 text-text-secondary hover:text-text-primary hover:bg-bg-tertiary transition-colors"
                        >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-3 w-full text-left text-red-400 hover:bg-bg-tertiary transition-colors"
                      >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
